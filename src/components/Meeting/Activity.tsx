...
export const Activity = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setUseData(data.meetingPage[0].section7.content3);
    }
    fetchData();
  }, []);
  return (
    <div className="flex flex-1 flex-col justify-start w-full desktop:max-w-[976px]  ">
      <div className="text-16M text-primary px-3 desktop:px-0">Activity</div>
      <div className="relative w-fit px-3 desktop:px-0">
        <div className="text-black text-48M  relative z-10 ">活動類型</div>
