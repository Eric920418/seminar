...
--
-- Name: Color; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public."Color" OWNER TO admin;

--
-- Name: Color_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--
...
ALTER SEQUENCE public."Color_id_seq" OWNER TO admin;

--
-- Name: Color_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--
...
--
-- Name: Logo; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public."Logo" OWNER TO admin;

--
-- Name: Logo_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--
...
ALTER SEQUENCE public."Logo_id_seq" OWNER TO admin;

--
-- Name: Logo_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--
...
--
-- Name: Color id; Type: DEFAULT; Schema: public; Owner: admin
--
...
--
-- Name: Logo id; Type: DEFAULT; Schema: public; Owner: admin
--
...
--
-- Data for Name: Color; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public."Color" (id, "createdAt", "updatedAt", section1) FROM stdin;
1	2025-03-24 21:25:00.824	2025-03-24 21:25:00.824	{"black": "#252f38", "third": "#0dc7ab", "white": "#ffffff", "primary": "#ffad42 ", "warning": "#ff6231", "secondary": "#008785"}
\.
...
--
-- Data for Name: Logo; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public."Logo" (id, "createdAt", "updatedAt", section1) FROM stdin;
1	2025-03-24 16:28:45.392	2025-03-24 16:28:45.392	{"image": "/image/1742805656780-logo.png"}
\.
...
1	2025-03-22 16:28:06.887	2025-03-22 16:28:06.887	{"list": [{"date": "3.10", "content": "<p>5t5g5</p>"}, {"date": "3.11", "content": "<p>wwwww</p>"}]}	{"times": {"time1": "efe", "time2": "111111", "time6": "efef", "time7": "efef", "time8": "fe", "dinner": "fef", "extend": ["ererge", "ef", "efef"], "meeting": "fe"}}	{"time1": "一、 主持人開場：10分鐘。\\n二、與談人發表時間：各20分鐘，共40分鐘。\\n三、來賓及與談人Q&A時間：10分鐘。", "time2": "一、主持人開場：5分鐘。\\n二、主講人發表時間：40分鐘。\\n三​、來賓與主講人Q&A時間：5分鐘。", "time3": "一、主持人開場時間：3分鐘（含播放議事規則影片）。\\n二​、各主題發表時間20分鐘，於19分鐘按一聲短鈴，於20分鐘按一聲長鈴提醒並結束發表。\\n三、​ 最後由主持人帶領討論Q&A，時間5分鐘。\\n四、若該場次發表4篇，則各主題發表時間15分鐘，於14分鐘按一聲短鈴，於15分鐘按一聲長鈴提醒並結束發表。\\n五、主持人可視需求彈性延長各篇發表及討論時間。", "time4": "一、由主講老師自行分配。\\n二​​​、中間穿插20分鐘休息時間。", "time5": "一、主持人時間：10分鐘。\\n二、主講人時間：各20分鐘，共80分鐘。\\n三、最後由主持人帶Q&A，時間10分鐘。", "content1": "各場次皆為60分鐘", "content2": "各場次皆為50分鐘", "content3": "每場次3-4篇，60-80分鐘", "content4": "各場次皆為140分鐘（含休息）", "content5": "100分鐘"}	{"url": "2025／10／16", "form": "全部場次已額滿，​線上報名​已截止，亦不接受現場報名。若有報名可查看報名成功名單。​", "date1": "https://tailwindcss.com/plus/ui-blocks/marketing/sections/contact-sections", "date2": "2025／10／16", "content": "感謝您對本研討會的支持與關注！如果您有意參加，請先填寫以下的 Google 線上報名表單，當報名截止時可查看一般與會者 報名成功名單（按照姓氏筆畫排列，電話末三碼為確認身分用，如有同名者可用電話末三碼加以區分）。 本研討會不接受現場報名，將以報名資訊確認信中的 QR code為報到依據。本研討會不收取任何費用，誠摯邀請您踴躍報名，期待在活動現場與您相見。"}	{"location": "國立臺北教育大學至善樓國際會議廳"}	[{"map": "10644 台北市大安區和平東路一段147號", "url": "https://www.moxytaichung.com/", "form": "https://bit.ly/4cvFmAp", "image": "/image/1742794912407-img.png", "phone": "+886-4-3600-7000", "title": "台北福華大飯店", "content": "走路​​到國立台北教育大學只要8分鐘！", "location": "10644 台北市大安區和平東路一段147號"}, {"map": "10644 台北市大安區和平東路一段147號", "url": "https://www.moxytaichung.com/", "form": "https://bit.ly/4cvFmAp", "image": "/image/1742794918257-img2.png", "phone": "+886-4-3600-7000", "title": "台北福華大飯店", "content": "走路​​到國立台北教育大學只要8分鐘！", "location": "10644 台北市大安區和平東路一段147號"}, {"map": "10644 台北市大安區和平東路一段147號", "url": "https://www.moxytaichung.com/", "form": "https://bit.ly/4cvFmAp", "image": "/image/1742794925161-img3.png", "phone": "+886-4-3600-7000", "title": "台北福華大飯店", "content": "走路​​到國立台北教育大學只要8分鐘！", "location": "10644 台北市大安區和平東路一段147號"}]	{"MapUrl": "/image/1742719170499-Rectangle-235.png"}
\.
...
1	2025-03-19 10:11:44.237	2025-03-19 10:11:44.237	{"tab": [{"card": [{"title": "教育應該不一樣從全球化到在地化", "videos": "O4_yQW9VNxY", "content": "楊志敏副教授｜國立屏東大學 師資培育中心"}, {"title": "第二個影片標題", "videos": "50K4a0SLI2M", "content": "這是第二個影片的內容"}], "video": "WJOrGjZhEyM"}, {"card": [{"title": "第三個影片標題", "videos": "CMp9Zq8VRa4", "content": "這是第三個影片的內容"}], "video": "50K4a0SLI2M"}]}
\.
...
58e38a23-591b-4aeb-bbef-0e3acedc9412	f00aca45600c96cb032cbc7a262eb847140b9d6ca4ed10e70cfaa18d5a952c14	2025-03-24 21:23:08.148483+08	20250324132308_update	\N	\N	2025-03-24 21:23:08.139781+08	1
...
1d09f3d8-ca51-487e-a9a1-ac82b8df8de0	32320ca22b13a96f876bacae1837dff96f5424246cc756aa8b30020bf7d2599f	2025-03-24 16:25:48.730995+08	20250324082548_update	\N	\N	2025-03-24 16:25:48.703567+08	1
\.


--
-- Name: Color_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public."Color_id_seq"', 1, true);
...
--
-- Name: Logo_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--
...
--
-- Name: Color Color_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: Logo Logo_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
